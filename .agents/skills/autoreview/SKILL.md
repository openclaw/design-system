...
- Reviewer subprocesses receive a minimal path/config environment. Authenticate CLIs through their persisted login or keyring; API keys, tokens, passwords, and unrelated host variables are intentionally not forwarded.
