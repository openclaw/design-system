...
const contents = {
  ...
  "primitive-provider-logo": () =>
    ...
    <section data-section-kind="preview" aria-labelledby="provider-logo-preview"><div class="section-heading"><div><p class="eyebrow">Preview</p><h2 id="provider-logo-preview">Integration identity</h2></div><span class="oc-pill">.oc-provider-logo</span></div>
      <div class="specimen-frame"><div class="provider-logo-gallery" aria-label="Provider logo examples"><span class="oc-provider-logo"><span class="oc-provider-logo-mark" data-provider="openai" aria-hidden="true">O</span><span>OpenAI</span></span><span class="oc-provider-logo"><span class="oc-provider-logo-mark" data-provider="anthropic" aria-hidden="true">A</span><span>Anthropic</span></span><span class="oc-provider-logo"><span class="oc-provider-logo-mark" data-provider="google" aria-hidden="true">G</span><span>Google</span></span></div></div>
    </section>
