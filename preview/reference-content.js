...
<span class="oc-avatar oc-avatar-pixel" data-animated="true" role="img" aria-label="Shelly">…</span>`, "html")}</section>
  ...
  "primitive-brand-banner": () =>
    ...
    <section data-section-kind="guidance" aria-labelledby="brand-banner-guidance"><div class="section-heading"><div><p class="eyebrow">Guidance</p><h2 id="brand-banner-guidance">One band, many assets</h2></div></div>${guidanceList(["Anchor the art so the focal point never clips: the crustacean artwork is top-anchored, photography is usually bottom-anchored.", "Use the fade effect whenever copy sits on the band; wash and grid are decorative and need high-contrast content.", "The shader pass restyles any same-origin image at bind time: dither maps it into the ember house palette, pixelate coarsens it, duotone remaps it to two tones. Use it to make arbitrary artwork sit in the brand.", "The strip size is for section headers and empty states; reserve the hero size for page-level introductions.", "Ship real assets from the consumer; the generated reef, swell, and bloom artworks show the band working without any binary asset."])}</section>`,
