...
export function clawAvatarUrl() {
  // Default identity: a pixel crab — eye stalks, two big pincers, side
  // legs — for agents and surfaces without their own avatar.
  const shell = "#f5654a";
  const deep = "#b23a28";
  const mid = "#e05540";
  const glow = "#ffd166";
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" shape-rendering="crispEdges"><rect width="40" height="40" fill="#17151d"/><rect x="4" y="4" width="32" height="32" rx="6" fill="${shell}" opacity=".12"/><rect x="14" y="5" width="2" height="6" fill="${mid}"/><rect x="24" y="5" width="2" height="6" fill="${mid}"/><rect x="13" y="3" width="4" height="4" fill="${glow}"/><rect x="23" y="3" width="4" height="4" fill="${glow}"/><rect x="14" y="4" width="2" height="2" fill="#19191d"/><rect x="24" y="4" width="2" height="2" fill="#19191d"/><rect x="2" y="10" width="8" height="8" fill="${shell}"/><rect x="30" y="10" width="8" height="8" fill="${shell}"/><rect x="6" y="8" width="4" height="3" fill="${shell}"/><rect x="30" y="8" width="4" height="3" fill="${shell}"/><rect x="2" y="13" width="3" height="2" fill="#17151d"/><rect x="35" y="13" width="3" height="2" fill="#17151d"/><rect x="6" y="16" width="4" height="4" fill="${mid}"/><rect x="30" y="16" width="4" height="4" fill="${mid}"/><rect x="10" y="14" width="20" height="16" fill="${shell}"/><rect x="8" y="18" width="2" height="8" fill="${mid}"/><rect x="30" y="18" width="2" height="8" fill="${mid}"/><rect x="12" y="12" width="16" height="2" fill="${mid}"/><rect x="14" y="18" width="4" height="4" fill="#19191d"/><rect x="22" y="18" width="4" height="4" fill="#19191d"/><rect x="15" y="19" width="1" height="1" fill="#fff"/><rect x="23" y="19" width="1" height="1" fill="#fff"/><rect x="17" y="25" width="6" height="2" fill="${deep}"/><rect x="16" y="24" width="1" height="2" fill="${deep}"/><rect x="23" y="24" width="1" height="2" fill="${deep}"/><rect x="4" y="24" width="6" height="2" fill="${mid}"/><rect x="30" y="24" width="6" height="2" fill="${mid}"/><rect x="3" y="28" width="7" height="2" fill="${mid}"/><rect x="30" y="28" width="7" height="2" fill="${mid}"/><rect x="5" y="32" width="6" height="2" fill="${deep}"/><rect x="29" y="32" width="6" height="2" fill="${deep}"/><rect x="12" y="30" width="16" height="4" fill="${mid}"/><rect x="14" y="34" width="12" height="2" fill="${deep}"/></svg>`;
  return `data:image/svg+xml,${encodeURIComponent(svg)}`;
}
